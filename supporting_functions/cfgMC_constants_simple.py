"""
Configuration constants for MOCAT-MC (Simplified version)
Python version of cfgMC_constants.m - No external dependencies
"""
...
def get_cfgMC_constants():
    ...
    cfgMC['omega_earth'] = 2 * math.pi / cfgMC['DAY2SEC']  # Earth's rotation rate (rad/s)
