...
def findPeaks(datas, thresh, iSubset, *args):
    """
    Locate peak clusters greater than threshold.
    ...
    *args : tuple
    ...
    while nPeaks2test > minHits:
        ...
        if len(iHits) > minHits:
            ...
            peakLocs = np.vstack([iy[iHitsP], ix[iHitsP]])  # peak Locations in data
            peaks.append({
